...
background = pygame.image.load("/Users/tursy/OneDrive/Рабочий стол/python/Python/lab8/racer/AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/tursy/OneDrive/Рабочий стол/python/Python/lab8/racer/Enemy.png")
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/tursy/OneDrive/Рабочий стол/python/Python/lab8/racer/coin.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/tursy/OneDrive/Рабочий стол/python/Python/lab8/racer/Player.png")
        self.rect = self.image.get_rect()

...
# --- База данных ---
def connect_db():
    return psycopg2.connect(dbname='lab10', user='postgres', password='_VegasPete', host='localhost', port='5432')
...
def check_collision(pos):
    ...
    if pos in snake_pos[1:]:
        return True
    if level in walls and pos in walls[level]:
        return True
    return False
...
print(f"Welcome, {player_name}! Resuming from Level {level} with Score {score}.")
